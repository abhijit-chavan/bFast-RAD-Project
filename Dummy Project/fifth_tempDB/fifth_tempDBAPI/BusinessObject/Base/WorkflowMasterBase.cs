...
namespace fifth_tempDBAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class WorkflowMasterBase : fifth_tempDBAPI.Models.WorkflowMasterModel
     {
         ...
         public static List<WorkflowMaster> SortByExpression(List<WorkflowMaster> objWorkflowMasterCol, string sortExpression)
         {
             ...
             {
                 case "WorkflowId":
                     objWorkflowMasterCol.Sort(fifth_tempDBAPI.BusinessObject.WorkflowMaster.ByWorkflowId);
                     break;
                 case "WorkflowName":
                     objWorkflowMasterCol.Sort(fifth_tempDBAPI.BusinessObject.WorkflowMaster.ByWorkflowName);
                     break;
                 case "LevelOfApprovals":
                     objWorkflowMasterCol.Sort(fifth_tempDBAPI.BusinessObject.WorkflowMaster.ByLevelOfApprovals);
                     break;
                 case "CreatedBy":
                     objWorkflowMasterCol.Sort(fifth_tempDBAPI.BusinessObject.WorkflowMaster.ByCreatedBy);
                     break;
                 case "CreatedOn":
                     objWorkflowMasterCol.Sort(fifth_tempDBAPI.BusinessObject.WorkflowMaster.ByCreatedOn);
                     break;
                 case "Updatedby":
                     objWorkflowMasterCol.Sort(fifth_tempDBAPI.BusinessObject.WorkflowMaster.ByUpdatedby);
                     break;
                 case "Updatedon":
                     objWorkflowMasterCol.Sort(fifth_tempDBAPI.BusinessObject.WorkflowMaster.ByUpdatedon);
                     break;
                 default:
                     break;
             }
