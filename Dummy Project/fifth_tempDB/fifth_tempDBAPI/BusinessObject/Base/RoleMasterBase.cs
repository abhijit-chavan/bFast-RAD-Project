...
namespace fifth_tempDBAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class RoleMasterBase : fifth_tempDBAPI.Models.RoleMasterModel
     {
         ...
         public static List<RoleMaster> SortByExpression(List<RoleMaster> objRoleMasterCol, string sortExpression)
         {
             ...
             {
                 case "RoleId":
                     objRoleMasterCol.Sort(fifth_tempDBAPI.BusinessObject.RoleMaster.ByRoleId);
                     break;
                 case "RoleDescription":
                     objRoleMasterCol.Sort(fifth_tempDBAPI.BusinessObject.RoleMaster.ByRoleDescription);
                     break;
                 case "CreatedOn":
                     objRoleMasterCol.Sort(fifth_tempDBAPI.BusinessObject.RoleMaster.ByCreatedOn);
                     break;
                 case "CreatedBy":
                     objRoleMasterCol.Sort(fifth_tempDBAPI.BusinessObject.RoleMaster.ByCreatedBy);
                     break;
                 case "ModifiedOn":
                     objRoleMasterCol.Sort(fifth_tempDBAPI.BusinessObject.RoleMaster.ByModifiedOn);
                     break;
                 case "ModifiedBy":
                     objRoleMasterCol.Sort(fifth_tempDBAPI.BusinessObject.RoleMaster.ByModifiedBy);
                     break;
                 default:
                     break;
             }
