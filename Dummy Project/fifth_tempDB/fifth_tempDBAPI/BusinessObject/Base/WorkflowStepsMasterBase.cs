...
namespace fifth_tempDBAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class WorkflowStepsMasterBase : fifth_tempDBAPI.Models.WorkflowStepsMasterModel
     {
         ...
         public static List<WorkflowStepsMaster> SortByExpression(List<WorkflowStepsMaster> objWorkflowStepsMasterCol, string sortExpression)
         {
             ...
             {
                 case "StepId":
                     objWorkflowStepsMasterCol.Sort(fifth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByStepId);
                     break;
                 case "WorKflowId":
                     objWorkflowStepsMasterCol.Sort(fifth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByWorKflowId);
                     break;
                 case "ApprovalLevel":
                     objWorkflowStepsMasterCol.Sort(fifth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByApprovalLevel);
                     break;
                 case "Description":
                     objWorkflowStepsMasterCol.Sort(fifth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByDescription);
                     break;
                 case "AutoApprove":
                     objWorkflowStepsMasterCol.Sort(fifth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByAutoApprove);
                     break;
                 case "WaitTime":
                     objWorkflowStepsMasterCol.Sort(fifth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByWaitTime);
                     break;
                 case "CreatedBy":
                     objWorkflowStepsMasterCol.Sort(fifth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByCreatedBy);
                     break;
                 case "CreatedOn":
                     objWorkflowStepsMasterCol.Sort(fifth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByCreatedOn);
                     break;
                 case "UpdatedBy":
                     objWorkflowStepsMasterCol.Sort(fifth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByUpdatedBy);
                     break;
                 case "UpdatedOn":
                     objWorkflowStepsMasterCol.Sort(fifth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByUpdatedOn);
                     break;
                 default:
                     break;
             }
