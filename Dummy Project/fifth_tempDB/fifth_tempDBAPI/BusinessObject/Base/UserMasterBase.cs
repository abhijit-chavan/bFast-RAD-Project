...
namespace fifth_tempDBAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class UserMasterBase : fifth_tempDBAPI.Models.UserMasterModel
     {
         ...
         public static List<UserMaster> SortByExpression(List<UserMaster> objUserMasterCol, string sortExpression)
         {
             ...
             {
                 case "UserId":
                     objUserMasterCol.Sort(fifth_tempDBAPI.BusinessObject.UserMaster.ByUserId);
                     break;
                 case "UserName":
                     objUserMasterCol.Sort(fifth_tempDBAPI.BusinessObject.UserMaster.ByUserName);
                     break;
                 case "Password":
                     objUserMasterCol.Sort(fifth_tempDBAPI.BusinessObject.UserMaster.ByPassword);
                     break;
                 case "Email":
                     objUserMasterCol.Sort(fifth_tempDBAPI.BusinessObject.UserMaster.ByEmail);
                     break;
                 case "CreatedOn":
                     objUserMasterCol.Sort(fifth_tempDBAPI.BusinessObject.UserMaster.ByCreatedOn);
                     break;
                 case "CreatedBy":
                     objUserMasterCol.Sort(fifth_tempDBAPI.BusinessObject.UserMaster.ByCreatedBy);
                     break;
                 case "ModifiedOn":
                     objUserMasterCol.Sort(fifth_tempDBAPI.BusinessObject.UserMaster.ByModifiedOn);
                     break;
                 case "ModifiedBy":
                     objUserMasterCol.Sort(fifth_tempDBAPI.BusinessObject.UserMaster.ByModifiedBy);
                     break;
                 default:
                     break;
             }
