...
namespace StudentEnquiryAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class UserMasterBase : StudentEnquiryAPI.Models.UserMasterModel
     {
         ...
         public static List<UserMaster> SortByExpression(List<UserMaster> objUserMasterCol, string sortExpression)
         {
             ...
             {
                 case "UserId":
                     objUserMasterCol.Sort(StudentEnquiryAPI.BusinessObject.UserMaster.ByUserId);
                     break;
                 case "UserName":
                     objUserMasterCol.Sort(StudentEnquiryAPI.BusinessObject.UserMaster.ByUserName);
                     break;
                 case "Password":
                     objUserMasterCol.Sort(StudentEnquiryAPI.BusinessObject.UserMaster.ByPassword);
                     break;
                 case "Email":
                     objUserMasterCol.Sort(StudentEnquiryAPI.BusinessObject.UserMaster.ByEmail);
                     break;
                 case "CreatedOn":
                     objUserMasterCol.Sort(StudentEnquiryAPI.BusinessObject.UserMaster.ByCreatedOn);
                     break;
                 case "CreatedBy":
                     objUserMasterCol.Sort(StudentEnquiryAPI.BusinessObject.UserMaster.ByCreatedBy);
                     break;
                 case "ModifiedOn":
                     objUserMasterCol.Sort(StudentEnquiryAPI.BusinessObject.UserMaster.ByModifiedOn);
                     break;
                 case "ModifiedBy":
                     objUserMasterCol.Sort(StudentEnquiryAPI.BusinessObject.UserMaster.ByModifiedBy);
                     break;
                 default:
                     break;
             }
