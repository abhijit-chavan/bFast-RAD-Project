...
namespace StudentEnquiryAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class UserRolesBase : StudentEnquiryAPI.Models.UserRolesModel
     {
         ...
         public static List<UserRoles> SortByExpression(List<UserRoles> objUserRolesCol, string sortExpression)
         {
             ...
             {
                 case "UserRoleId":
                     objUserRolesCol.Sort(StudentEnquiryAPI.BusinessObject.UserRoles.ByUserRoleId);
                     break;
                 case "UserId":
                     objUserRolesCol.Sort(StudentEnquiryAPI.BusinessObject.UserRoles.ByUserId);
                     break;
                 case "RoleId":
                     objUserRolesCol.Sort(StudentEnquiryAPI.BusinessObject.UserRoles.ByRoleId);
                     break;
                 case "Status":
                     objUserRolesCol.Sort(StudentEnquiryAPI.BusinessObject.UserRoles.ByStatus);
                     break;
                 default:
                     break;
             }
