...
namespace StudentEnquiryAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class WorkflowStepsMasterBase : StudentEnquiryAPI.Models.WorkflowStepsMasterModel
     {
         ...
         public static List<WorkflowStepsMaster> SortByExpression(List<WorkflowStepsMaster> objWorkflowStepsMasterCol, string sortExpression)
         {
             ...
             {
                 case "StepId":
                     objWorkflowStepsMasterCol.Sort(StudentEnquiryAPI.BusinessObject.WorkflowStepsMaster.ByStepId);
                     break;
                 case "WorKflowId":
                     objWorkflowStepsMasterCol.Sort(StudentEnquiryAPI.BusinessObject.WorkflowStepsMaster.ByWorKflowId);
                     break;
                 case "ApprovalLevel":
                     objWorkflowStepsMasterCol.Sort(StudentEnquiryAPI.BusinessObject.WorkflowStepsMaster.ByApprovalLevel);
                     break;
                 case "Description":
                     objWorkflowStepsMasterCol.Sort(StudentEnquiryAPI.BusinessObject.WorkflowStepsMaster.ByDescription);
                     break;
                 case "AutoApprove":
                     objWorkflowStepsMasterCol.Sort(StudentEnquiryAPI.BusinessObject.WorkflowStepsMaster.ByAutoApprove);
                     break;
                 case "WaitTime":
                     objWorkflowStepsMasterCol.Sort(StudentEnquiryAPI.BusinessObject.WorkflowStepsMaster.ByWaitTime);
                     break;
                 case "CreatedBy":
                     objWorkflowStepsMasterCol.Sort(StudentEnquiryAPI.BusinessObject.WorkflowStepsMaster.ByCreatedBy);
                     break;
                 case "CreatedOn":
                     objWorkflowStepsMasterCol.Sort(StudentEnquiryAPI.BusinessObject.WorkflowStepsMaster.ByCreatedOn);
                     break;
                 case "UpdatedBy":
                     objWorkflowStepsMasterCol.Sort(StudentEnquiryAPI.BusinessObject.WorkflowStepsMaster.ByUpdatedBy);
                     break;
                 case "UpdatedOn":
                     objWorkflowStepsMasterCol.Sort(StudentEnquiryAPI.BusinessObject.WorkflowStepsMaster.ByUpdatedOn);
                     break;
                 default:
                     break;
             }
