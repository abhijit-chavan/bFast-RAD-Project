...
namespace StudentEnquiryAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class RoleMasterBase : StudentEnquiryAPI.Models.RoleMasterModel
     {
         ...
         public static List<RoleMaster> SortByExpression(List<RoleMaster> objRoleMasterCol, string sortExpression)
         {
             ...
             {
                 case "RoleId":
                     objRoleMasterCol.Sort(StudentEnquiryAPI.BusinessObject.RoleMaster.ByRoleId);
                     break;
                 case "RoleDescription":
                     objRoleMasterCol.Sort(StudentEnquiryAPI.BusinessObject.RoleMaster.ByRoleDescription);
                     break;
                 case "CreatedOn":
                     objRoleMasterCol.Sort(StudentEnquiryAPI.BusinessObject.RoleMaster.ByCreatedOn);
                     break;
                 case "CreatedBy":
                     objRoleMasterCol.Sort(StudentEnquiryAPI.BusinessObject.RoleMaster.ByCreatedBy);
                     break;
                 case "ModifiedOn":
                     objRoleMasterCol.Sort(StudentEnquiryAPI.BusinessObject.RoleMaster.ByModifiedOn);
                     break;
                 case "ModifiedBy":
                     objRoleMasterCol.Sort(StudentEnquiryAPI.BusinessObject.RoleMaster.ByModifiedBy);
                     break;
                 default:
                     break;
             }
