...
namespace CourseEnquiryAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class UserMasterBase : CourseEnquiryAPI.Models.UserMasterModel
     {
         ...
         public static List<UserMaster> SortByExpression(List<UserMaster> objUserMasterCol, string sortExpression)
         {
             ...
             {
                 case "UserId":
                     objUserMasterCol.Sort(CourseEnquiryAPI.BusinessObject.UserMaster.ByUserId);
                     break;
                 case "UserName":
                     objUserMasterCol.Sort(CourseEnquiryAPI.BusinessObject.UserMaster.ByUserName);
                     break;
                 case "Password":
                     objUserMasterCol.Sort(CourseEnquiryAPI.BusinessObject.UserMaster.ByPassword);
                     break;
                 case "Email":
                     objUserMasterCol.Sort(CourseEnquiryAPI.BusinessObject.UserMaster.ByEmail);
                     break;
                 case "CreatedOn":
                     objUserMasterCol.Sort(CourseEnquiryAPI.BusinessObject.UserMaster.ByCreatedOn);
                     break;
                 case "CreatedBy":
                     objUserMasterCol.Sort(CourseEnquiryAPI.BusinessObject.UserMaster.ByCreatedBy);
                     break;
                 case "ModifiedOn":
                     objUserMasterCol.Sort(CourseEnquiryAPI.BusinessObject.UserMaster.ByModifiedOn);
                     break;
                 case "ModifiedBy":
                     objUserMasterCol.Sort(CourseEnquiryAPI.BusinessObject.UserMaster.ByModifiedBy);
                     break;
                 default:
                     break;
             }
