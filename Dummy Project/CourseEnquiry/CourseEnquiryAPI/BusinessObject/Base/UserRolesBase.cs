...
namespace CourseEnquiryAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class UserRolesBase : CourseEnquiryAPI.Models.UserRolesModel
     {
         ...
         public static List<UserRoles> SortByExpression(List<UserRoles> objUserRolesCol, string sortExpression)
         {
             ...
             {
                 case "UserRoleId":
                     objUserRolesCol.Sort(CourseEnquiryAPI.BusinessObject.UserRoles.ByUserRoleId);
                     break;
                 case "UserId":
                     objUserRolesCol.Sort(CourseEnquiryAPI.BusinessObject.UserRoles.ByUserId);
                     break;
                 case "RoleId":
                     objUserRolesCol.Sort(CourseEnquiryAPI.BusinessObject.UserRoles.ByRoleId);
                     break;
                 case "Status":
                     objUserRolesCol.Sort(CourseEnquiryAPI.BusinessObject.UserRoles.ByStatus);
                     break;
                 default:
                     break;
             }
