...
namespace CourseEnquiryAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class CourseBase : CourseEnquiryAPI.Models.CourseModel
     {
         ...
         public static List<Course> SortByExpression(List<Course> objCourseCol, string sortExpression)
         {
             ...
             {
                 case "CourseId":
                     objCourseCol.Sort(CourseEnquiryAPI.BusinessObject.Course.ByCourseId);
                     break;
                 case "CourseName":
                     objCourseCol.Sort(CourseEnquiryAPI.BusinessObject.Course.ByCourseName);
                     break;
                 case "StartDate":
                     objCourseCol.Sort(CourseEnquiryAPI.BusinessObject.Course.ByStartDate);
                     break;
                 case "EndDate":
                     objCourseCol.Sort(CourseEnquiryAPI.BusinessObject.Course.ByEndDate);
                     break;
                 case "Fees":
                     objCourseCol.Sort(CourseEnquiryAPI.BusinessObject.Course.ByFees);
                     break;
                 default:
                     break;
             }
