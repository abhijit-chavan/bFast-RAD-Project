...
namespace CourseEnquiryAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class RoleMasterBase : CourseEnquiryAPI.Models.RoleMasterModel
     {
         ...
         public static List<RoleMaster> SortByExpression(List<RoleMaster> objRoleMasterCol, string sortExpression)
         {
             ...
             {
                 case "RoleId":
                     objRoleMasterCol.Sort(CourseEnquiryAPI.BusinessObject.RoleMaster.ByRoleId);
                     break;
                 case "RoleDescription":
                     objRoleMasterCol.Sort(CourseEnquiryAPI.BusinessObject.RoleMaster.ByRoleDescription);
                     break;
                 case "CreatedOn":
                     objRoleMasterCol.Sort(CourseEnquiryAPI.BusinessObject.RoleMaster.ByCreatedOn);
                     break;
                 case "CreatedBy":
                     objRoleMasterCol.Sort(CourseEnquiryAPI.BusinessObject.RoleMaster.ByCreatedBy);
                     break;
                 case "ModifiedOn":
                     objRoleMasterCol.Sort(CourseEnquiryAPI.BusinessObject.RoleMaster.ByModifiedOn);
                     break;
                 case "ModifiedBy":
                     objRoleMasterCol.Sort(CourseEnquiryAPI.BusinessObject.RoleMaster.ByModifiedBy);
                     break;
                 default:
                     break;
             }
