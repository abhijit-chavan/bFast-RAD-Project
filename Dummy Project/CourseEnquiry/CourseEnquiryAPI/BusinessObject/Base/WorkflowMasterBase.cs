...
namespace CourseEnquiryAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class WorkflowMasterBase : CourseEnquiryAPI.Models.WorkflowMasterModel
     {
         ...
         public static List<WorkflowMaster> SortByExpression(List<WorkflowMaster> objWorkflowMasterCol, string sortExpression)
         {
             ...
             {
                 case "WorkflowId":
                     objWorkflowMasterCol.Sort(CourseEnquiryAPI.BusinessObject.WorkflowMaster.ByWorkflowId);
                     break;
                 case "WorkflowName":
                     objWorkflowMasterCol.Sort(CourseEnquiryAPI.BusinessObject.WorkflowMaster.ByWorkflowName);
                     break;
                 case "LevelOfApprovals":
                     objWorkflowMasterCol.Sort(CourseEnquiryAPI.BusinessObject.WorkflowMaster.ByLevelOfApprovals);
                     break;
                 case "CreatedBy":
                     objWorkflowMasterCol.Sort(CourseEnquiryAPI.BusinessObject.WorkflowMaster.ByCreatedBy);
                     break;
                 case "CreatedOn":
                     objWorkflowMasterCol.Sort(CourseEnquiryAPI.BusinessObject.WorkflowMaster.ByCreatedOn);
                     break;
                 case "Updatedby":
                     objWorkflowMasterCol.Sort(CourseEnquiryAPI.BusinessObject.WorkflowMaster.ByUpdatedby);
                     break;
                 case "Updatedon":
                     objWorkflowMasterCol.Sort(CourseEnquiryAPI.BusinessObject.WorkflowMaster.ByUpdatedon);
                     break;
                 default:
                     break;
             }
