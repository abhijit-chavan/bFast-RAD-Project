...
namespace TemporaryDBappllicationAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class UserMasterBase : TemporaryDBappllicationAPI.Models.UserMasterModel
     {
         ...
         public static List<UserMaster> SortByExpression(List<UserMaster> objUserMasterCol, string sortExpression)
         {
             ...
             {
                 case "UserId":
                     objUserMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.UserMaster.ByUserId);
                     break;
                 case "UserName":
                     objUserMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.UserMaster.ByUserName);
                     break;
                 case "Password":
                     objUserMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.UserMaster.ByPassword);
                     break;
                 case "Email":
                     objUserMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.UserMaster.ByEmail);
                     break;
                 case "CreatedOn":
                     objUserMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.UserMaster.ByCreatedOn);
                     break;
                 case "CreatedBy":
                     objUserMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.UserMaster.ByCreatedBy);
                     break;
                 case "ModifiedOn":
                     objUserMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.UserMaster.ByModifiedOn);
                     break;
                 case "ModifiedBy":
                     objUserMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.UserMaster.ByModifiedBy);
                     break;
                 default:
                     break;
             }
