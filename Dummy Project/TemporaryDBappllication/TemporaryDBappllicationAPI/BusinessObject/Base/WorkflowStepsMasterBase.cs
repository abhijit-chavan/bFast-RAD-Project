...
namespace TemporaryDBappllicationAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class WorkflowStepsMasterBase : TemporaryDBappllicationAPI.Models.WorkflowStepsMasterModel
     {
         ...
         public static List<WorkflowStepsMaster> SortByExpression(List<WorkflowStepsMaster> objWorkflowStepsMasterCol, string sortExpression)
         {
             ...
             {
                 case "StepId":
                     objWorkflowStepsMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.WorkflowStepsMaster.ByStepId);
                     break;
                 case "WorKflowId":
                     objWorkflowStepsMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.WorkflowStepsMaster.ByWorKflowId);
                     break;
                 case "ApprovalLevel":
                     objWorkflowStepsMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.WorkflowStepsMaster.ByApprovalLevel);
                     break;
                 case "Description":
                     objWorkflowStepsMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.WorkflowStepsMaster.ByDescription);
                     break;
                 case "AutoApprove":
                     objWorkflowStepsMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.WorkflowStepsMaster.ByAutoApprove);
                     break;
                 case "WaitTime":
                     objWorkflowStepsMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.WorkflowStepsMaster.ByWaitTime);
                     break;
                 case "CreatedBy":
                     objWorkflowStepsMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.WorkflowStepsMaster.ByCreatedBy);
                     break;
                 case "CreatedOn":
                     objWorkflowStepsMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.WorkflowStepsMaster.ByCreatedOn);
                     break;
                 case "UpdatedBy":
                     objWorkflowStepsMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.WorkflowStepsMaster.ByUpdatedBy);
                     break;
                 case "UpdatedOn":
                     objWorkflowStepsMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.WorkflowStepsMaster.ByUpdatedOn);
                     break;
                 default:
                     break;
             }
