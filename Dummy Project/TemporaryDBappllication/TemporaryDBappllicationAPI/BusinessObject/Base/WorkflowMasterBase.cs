...
namespace TemporaryDBappllicationAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class WorkflowMasterBase : TemporaryDBappllicationAPI.Models.WorkflowMasterModel
     {
         ...
         public static List<WorkflowMaster> SortByExpression(List<WorkflowMaster> objWorkflowMasterCol, string sortExpression)
         {
             ...
             {
                 case "WorkflowId":
                     objWorkflowMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.WorkflowMaster.ByWorkflowId);
                     break;
                 case "WorkflowName":
                     objWorkflowMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.WorkflowMaster.ByWorkflowName);
                     break;
                 case "LevelOfApprovals":
                     objWorkflowMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.WorkflowMaster.ByLevelOfApprovals);
                     break;
                 case "CreatedBy":
                     objWorkflowMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.WorkflowMaster.ByCreatedBy);
                     break;
                 case "CreatedOn":
                     objWorkflowMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.WorkflowMaster.ByCreatedOn);
                     break;
                 case "Updatedby":
                     objWorkflowMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.WorkflowMaster.ByUpdatedby);
                     break;
                 case "Updatedon":
                     objWorkflowMasterCol.Sort(TemporaryDBappllicationAPI.BusinessObject.WorkflowMaster.ByUpdatedon);
                     break;
                 default:
                     break;
             }
