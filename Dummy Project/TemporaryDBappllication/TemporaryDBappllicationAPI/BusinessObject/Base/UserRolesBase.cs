...
namespace TemporaryDBappllicationAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class UserRolesBase : TemporaryDBappllicationAPI.Models.UserRolesModel
     {
         ...
         public static List<UserRoles> SortByExpression(List<UserRoles> objUserRolesCol, string sortExpression)
         {
             ...
             {
                 case "UserRoleId":
                     objUserRolesCol.Sort(TemporaryDBappllicationAPI.BusinessObject.UserRoles.ByUserRoleId);
                     break;
                 case "UserId":
                     objUserRolesCol.Sort(TemporaryDBappllicationAPI.BusinessObject.UserRoles.ByUserId);
                     break;
                 case "RoleId":
                     objUserRolesCol.Sort(TemporaryDBappllicationAPI.BusinessObject.UserRoles.ByRoleId);
                     break;
                 case "Status":
                     objUserRolesCol.Sort(TemporaryDBappllicationAPI.BusinessObject.UserRoles.ByStatus);
                     break;
                 default:
                     break;
             }
