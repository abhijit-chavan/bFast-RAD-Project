...
namespace TemporaryDBappllicationAPI
{
    public partial class TemporaryDBContext : DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(@"Server=DESKTOP-UAS3KBE\SQLEXPRESS01;Database=TemporaryDB;User ID=abhijit;Password=Abhiraj@18;");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<RoleMaster>(entity =>
            {
                entity.HasKey(e => e.RoleId)
                    .HasName("PK__RoleMast__8AFACE1AE9D00782");
            ...
            modelBuilder.Entity<UserMaster>(entity =>
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__UserMast__1788CC4CE9D1DC8E");
            ...
            modelBuilder.Entity<UserRoles>(entity =>
            {
                entity.HasKey(e => e.UserRoleId)
                    .HasName("PK__UserRole__3D978A356661C292");
            ...
            modelBuilder.Entity<WorkflowMaster>(entity =>
            {
                entity.HasKey(e => e.WorkflowId)
                    .HasName("PK__Workflow__5704A66AE9EF73C4");
            ...
            modelBuilder.Entity<WorkflowStepsMaster>(entity =>
            {
                entity.HasKey(e => e.StepId)
                    .HasName("PK__Workflow__24343357D613FADC");
