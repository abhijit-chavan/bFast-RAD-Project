...
namespace CourseEnquiry1API.BusinessObject.Base
{
     ...
     /// </summary>
     public class UserRolesBase : CourseEnquiry1API.Models.UserRolesModel
     {
         ...
         public static List<UserRoles> SortByExpression(List<UserRoles> objUserRolesCol, string sortExpression)
         {
             ...
             {
                 case "UserRoleId":
                     objUserRolesCol.Sort(CourseEnquiry1API.BusinessObject.UserRoles.ByUserRoleId);
                     break;
                 case "UserId":
                     objUserRolesCol.Sort(CourseEnquiry1API.BusinessObject.UserRoles.ByUserId);
                     break;
                 case "RoleId":
                     objUserRolesCol.Sort(CourseEnquiry1API.BusinessObject.UserRoles.ByRoleId);
                     break;
                 case "Status":
                     objUserRolesCol.Sort(CourseEnquiry1API.BusinessObject.UserRoles.ByStatus);
                     break;
                 default:
                     break;
             }
