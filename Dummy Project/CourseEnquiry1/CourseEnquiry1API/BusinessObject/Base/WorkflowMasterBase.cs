...
namespace CourseEnquiry1API.BusinessObject.Base
{
     ...
     /// </summary>
     public class WorkflowMasterBase : CourseEnquiry1API.Models.WorkflowMasterModel
     {
         ...
         public static List<WorkflowMaster> SortByExpression(List<WorkflowMaster> objWorkflowMasterCol, string sortExpression)
         {
             ...
             {
                 case "WorkflowId":
                     objWorkflowMasterCol.Sort(CourseEnquiry1API.BusinessObject.WorkflowMaster.ByWorkflowId);
                     break;
                 case "WorkflowName":
                     objWorkflowMasterCol.Sort(CourseEnquiry1API.BusinessObject.WorkflowMaster.ByWorkflowName);
                     break;
                 case "LevelOfApprovals":
                     objWorkflowMasterCol.Sort(CourseEnquiry1API.BusinessObject.WorkflowMaster.ByLevelOfApprovals);
                     break;
                 case "CreatedBy":
                     objWorkflowMasterCol.Sort(CourseEnquiry1API.BusinessObject.WorkflowMaster.ByCreatedBy);
                     break;
                 case "CreatedOn":
                     objWorkflowMasterCol.Sort(CourseEnquiry1API.BusinessObject.WorkflowMaster.ByCreatedOn);
                     break;
                 case "Updatedby":
                     objWorkflowMasterCol.Sort(CourseEnquiry1API.BusinessObject.WorkflowMaster.ByUpdatedby);
                     break;
                 case "Updatedon":
                     objWorkflowMasterCol.Sort(CourseEnquiry1API.BusinessObject.WorkflowMaster.ByUpdatedon);
                     break;
                 default:
                     break;
             }
