...
namespace CourseEnquiry1API.BusinessObject.Base
{
     ...
     /// </summary>
     public class RoleMasterBase : CourseEnquiry1API.Models.RoleMasterModel
     {
         ...
         public static List<RoleMaster> SortByExpression(List<RoleMaster> objRoleMasterCol, string sortExpression)
         {
             ...
             {
                 case "RoleId":
                     objRoleMasterCol.Sort(CourseEnquiry1API.BusinessObject.RoleMaster.ByRoleId);
                     break;
                 case "RoleDescription":
                     objRoleMasterCol.Sort(CourseEnquiry1API.BusinessObject.RoleMaster.ByRoleDescription);
                     break;
                 case "CreatedOn":
                     objRoleMasterCol.Sort(CourseEnquiry1API.BusinessObject.RoleMaster.ByCreatedOn);
                     break;
                 case "CreatedBy":
                     objRoleMasterCol.Sort(CourseEnquiry1API.BusinessObject.RoleMaster.ByCreatedBy);
                     break;
                 case "ModifiedOn":
                     objRoleMasterCol.Sort(CourseEnquiry1API.BusinessObject.RoleMaster.ByModifiedOn);
                     break;
                 case "ModifiedBy":
                     objRoleMasterCol.Sort(CourseEnquiry1API.BusinessObject.RoleMaster.ByModifiedBy);
                     break;
                 default:
                     break;
             }
