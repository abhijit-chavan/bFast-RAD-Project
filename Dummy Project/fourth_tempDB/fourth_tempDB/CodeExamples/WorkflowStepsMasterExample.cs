...
public sealed class WorkflowStepsMasterExample
{
    ...
    private void Insert()
    {
        ...
        objWorkflowStepsMaster.WorKflowId = 1;
        objWorkflowStepsMaster.ApprovalLevel = "Level-0";
        objWorkflowStepsMaster.Description = "abc";
        objWorkflowStepsMaster.AutoApprove = "True";
        objWorkflowStepsMaster.WaitTime = 0;
        objWorkflowStepsMaster.CreatedBy = "abhijit";
    ...
    private void Update()
    {
        ...
        objWorkflowStepsMaster.StepId = 1;
    ...
    private void GetRecordCountByWorKflowId()
    {
        ...
        // 1 here is just a sample WorKflowId change the value as you see fit
        int totalRecordCount = WorkflowStepsMaster.GetRecordCountByWorKflowId(1);
    }
    ...
    private void SelectSkipAndTakeByWorKflowId()
    {
        ...
        // 1. select a specific number of sorted records with a WorKflowId = 1
        // starting from the index you specify
        List<WorkflowStepsMaster> objWorkflowStepsMasterCol = WorkflowStepsMaster.SelectSkipAndTakeByWorKflowId(numberOfRecordsToRetrieve, startRetrievalFromRecordIndex, sortBy, 1);
