...
namespace fourth_tempDBAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class RoleMasterBase : fourth_tempDBAPI.Models.RoleMasterModel
     {
         ...
         public static List<RoleMaster> SortByExpression(List<RoleMaster> objRoleMasterCol, string sortExpression)
         {
             ...
             {
                 case "RoleId":
                     objRoleMasterCol.Sort(fourth_tempDBAPI.BusinessObject.RoleMaster.ByRoleId);
                     break;
                 case "RoleDescription":
                     objRoleMasterCol.Sort(fourth_tempDBAPI.BusinessObject.RoleMaster.ByRoleDescription);
                     break;
                 case "CreatedOn":
                     objRoleMasterCol.Sort(fourth_tempDBAPI.BusinessObject.RoleMaster.ByCreatedOn);
                     break;
                 case "CreatedBy":
                     objRoleMasterCol.Sort(fourth_tempDBAPI.BusinessObject.RoleMaster.ByCreatedBy);
                     break;
                 case "ModifiedOn":
                     objRoleMasterCol.Sort(fourth_tempDBAPI.BusinessObject.RoleMaster.ByModifiedOn);
                     break;
                 case "ModifiedBy":
                     objRoleMasterCol.Sort(fourth_tempDBAPI.BusinessObject.RoleMaster.ByModifiedBy);
                     break;
                 default:
                     break;
             }
