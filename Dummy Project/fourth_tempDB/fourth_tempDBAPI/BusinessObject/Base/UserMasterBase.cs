...
namespace fourth_tempDBAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class UserMasterBase : fourth_tempDBAPI.Models.UserMasterModel
     {
         ...
         public static List<UserMaster> SortByExpression(List<UserMaster> objUserMasterCol, string sortExpression)
         {
             ...
             {
                 case "UserId":
                     objUserMasterCol.Sort(fourth_tempDBAPI.BusinessObject.UserMaster.ByUserId);
                     break;
                 case "UserName":
                     objUserMasterCol.Sort(fourth_tempDBAPI.BusinessObject.UserMaster.ByUserName);
                     break;
                 case "Password":
                     objUserMasterCol.Sort(fourth_tempDBAPI.BusinessObject.UserMaster.ByPassword);
                     break;
                 case "Email":
                     objUserMasterCol.Sort(fourth_tempDBAPI.BusinessObject.UserMaster.ByEmail);
                     break;
                 case "CreatedOn":
                     objUserMasterCol.Sort(fourth_tempDBAPI.BusinessObject.UserMaster.ByCreatedOn);
                     break;
                 case "CreatedBy":
                     objUserMasterCol.Sort(fourth_tempDBAPI.BusinessObject.UserMaster.ByCreatedBy);
                     break;
                 case "ModifiedOn":
                     objUserMasterCol.Sort(fourth_tempDBAPI.BusinessObject.UserMaster.ByModifiedOn);
                     break;
                 case "ModifiedBy":
                     objUserMasterCol.Sort(fourth_tempDBAPI.BusinessObject.UserMaster.ByModifiedBy);
                     break;
                 default:
                     break;
             }
