...
namespace fourth_tempDBAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class UserRolesBase : fourth_tempDBAPI.Models.UserRolesModel
     {
         ...
         public static List<UserRoles> SortByExpression(List<UserRoles> objUserRolesCol, string sortExpression)
         {
             ...
             {
                 case "UserRoleId":
                     objUserRolesCol.Sort(fourth_tempDBAPI.BusinessObject.UserRoles.ByUserRoleId);
                     break;
                 case "UserId":
                     objUserRolesCol.Sort(fourth_tempDBAPI.BusinessObject.UserRoles.ByUserId);
                     break;
                 case "RoleId":
                     objUserRolesCol.Sort(fourth_tempDBAPI.BusinessObject.UserRoles.ByRoleId);
                     break;
                 case "Status":
                     objUserRolesCol.Sort(fourth_tempDBAPI.BusinessObject.UserRoles.ByStatus);
                     break;
                 default:
                     break;
             }
