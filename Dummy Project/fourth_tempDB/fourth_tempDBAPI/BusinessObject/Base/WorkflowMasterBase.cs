...
namespace fourth_tempDBAPI.BusinessObject.Base
{
     ...
     /// </summary>
     public class WorkflowMasterBase : fourth_tempDBAPI.Models.WorkflowMasterModel
     {
         ...
         public static List<WorkflowMaster> SortByExpression(List<WorkflowMaster> objWorkflowMasterCol, string sortExpression)
         {
             ...
             {
                 case "WorkflowId":
                     objWorkflowMasterCol.Sort(fourth_tempDBAPI.BusinessObject.WorkflowMaster.ByWorkflowId);
                     break;
                 case "WorkflowName":
                     objWorkflowMasterCol.Sort(fourth_tempDBAPI.BusinessObject.WorkflowMaster.ByWorkflowName);
                     break;
                 case "LevelOfApprovals":
                     objWorkflowMasterCol.Sort(fourth_tempDBAPI.BusinessObject.WorkflowMaster.ByLevelOfApprovals);
                     break;
                 case "CreatedBy":
                     objWorkflowMasterCol.Sort(fourth_tempDBAPI.BusinessObject.WorkflowMaster.ByCreatedBy);
                     break;
                 case "CreatedOn":
                     objWorkflowMasterCol.Sort(fourth_tempDBAPI.BusinessObject.WorkflowMaster.ByCreatedOn);
                     break;
                 case "Updatedby":
                     objWorkflowMasterCol.Sort(fourth_tempDBAPI.BusinessObject.WorkflowMaster.ByUpdatedby);
                     break;
                 case "Updatedon":
                     objWorkflowMasterCol.Sort(fourth_tempDBAPI.BusinessObject.WorkflowMaster.ByUpdatedon);
                     break;
                 default:
                     break;
             }
