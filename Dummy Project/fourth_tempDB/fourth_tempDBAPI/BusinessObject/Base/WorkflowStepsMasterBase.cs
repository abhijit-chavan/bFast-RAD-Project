using System;
using fourth_tempDBAPI.DataLayer;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace fourth_tempDBAPI.BusinessObject.Base
{
     /// <summary>
     ...
     /// </summary>
     public class WorkflowStepsMasterBase : fourth_tempDBAPI.Models.WorkflowStepsMasterModel
     {
         ...
         public static List<WorkflowStepsMaster> SortByExpression(List<WorkflowStepsMaster> objWorkflowStepsMasterCol, string sortExpression)
         {
             ...
             {
                 case "StepId":
                     objWorkflowStepsMasterCol.Sort(fourth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByStepId);
                     break;
                 case "WorKflowId":
                     objWorkflowStepsMasterCol.Sort(fourth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByWorKflowId);
                     break;
                 case "ApprovalLevel":
                     objWorkflowStepsMasterCol.Sort(fourth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByApprovalLevel);
                     break;
                 case "Description":
                     objWorkflowStepsMasterCol.Sort(fourth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByDescription);
                     break;
                 case "AutoApprove":
                     objWorkflowStepsMasterCol.Sort(fourth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByAutoApprove);
                     break;
                 case "WaitTime":
                     objWorkflowStepsMasterCol.Sort(fourth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByWaitTime);
                     break;
                 case "CreatedBy":
                     objWorkflowStepsMasterCol.Sort(fourth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByCreatedBy);
                     break;
                 case "CreatedOn":
                     objWorkflowStepsMasterCol.Sort(fourth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByCreatedOn);
                     break;
                 case "UpdatedBy":
                     objWorkflowStepsMasterCol.Sort(fourth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByUpdatedBy);
                     break;
                 case "UpdatedOn":
                     objWorkflowStepsMasterCol.Sort(fourth_tempDBAPI.BusinessObject.WorkflowStepsMaster.ByUpdatedOn);
                     break;
                 default:
                     break;
             }
